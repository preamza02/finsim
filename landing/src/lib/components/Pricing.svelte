  ...
  <div class="container-custom">
    <div class="text-center mb-12">
      ...
      <p class="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
        Open Core model: Self-host for free forever, or use our cloud service with flexible Day Pass pricing.
      </p>

      <!-- Cloud/Open Source Toggle -->
      <div class="inline-flex items-center bg-gray-100 rounded-lg p-1">
        <button
          class="px-4 py-2 rounded-md text-sm font-medium transition-colors {selectedView === 'cloud' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-600 hover:text-gray-900'}"
          on:click={() => selectedView = 'cloud'}
        >
          ☁️ Cloud
        </button>
        <button
          class="px-4 py-2 rounded-md text-sm font-medium transition-colors {selectedView === 'opensource' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-600 hover:text-gray-900'}"
    ...
    {#if selectedView === 'cloud'}
      ...
      <div class="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
        {#each cloudPlans as plan}
          <div class="relative p-6 rounded-2xl border-2 {plan.highlighted ? 'border-primary-500 shadow-xl' : 'border-gray-200'} bg-white flex flex-col">
      ...
      <div class="mt-12 max-w-2xl mx-auto">
        <div class="bg-gradient-to-r from-primary-50 to-accent-50 rounded-2xl p-8 text-center border border-primary-100">
          <h3 class="text-xl font-bold text-gray-900 mb-2">Lifetime Access</h3>
          <p class="text-gray-600 mb-4">One-time payment, forever access. Support the mission.</p>
          <div class="mb-6">
      ...
      <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-2xl border-2 border-gray-200 p-8">
          <div class="text-center mb-8">
            ...
            <p class="text-gray-600">Full-featured, self-hosted on your machine. No limits, no strings attached.</p>
          </div>
