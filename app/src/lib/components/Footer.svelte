    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-6 gap-12">
      ...
      <div class="lg:col-span-2">
        <a href="/" class="flex items-center space-x-2 mb-4">
          <svg class="w-8 h-8 text-primary-500" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="flex space-x-4">
          <a href="https://github.com/preamza02/finsim" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-white transition-colors" aria-label="GitHub">
          ...
          <a href="https://twitter.com/finsim" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-white transition-colors" aria-label="Twitter">
            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
