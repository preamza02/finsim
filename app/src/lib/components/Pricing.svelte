        ...
        {#each cloudPlans as plan}
          ...
          >
            ...
            <CardContent class="flex-grow flex flex-col">
              ...
              <Button class="w-full {plan.highlighted ? 'bg-primary-600 hover:bg-primary-700' : 'bg-gray-100 hover:bg-gray-200 text-gray-900'}">
                <a
                  href={plan.ctaLink}
                  ...
                  rel={isExternalLink(plan.ctaLink)
                    ? "noopener noreferrer"
                    : undefined}
                  class="block w-full {plan.highlighted ? 'text-white' : 'text-gray-900'}"
                >
                  {plan.cta}
                </a>
              </Button>
